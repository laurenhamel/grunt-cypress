...
console.log(chalk `{green ✓} Successfully verified that your project has a \`cypress\` folder.`);
...
console.log(chalk`{green ✓} Successfully verified that your project has a \`cypress.json\` file.\n`);